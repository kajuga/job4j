CREATE TABLE tracker.item (id SERIAL PRIMARY KEY NOT NULL, name VARCHAR(100), descripton VARCHAR(150),
  comments INTEGER REFERENCES tracker.comment(id), creation_date DATE NOT NULL);
